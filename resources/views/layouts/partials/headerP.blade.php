<header class="header py-5 px-5 bg-black">
    <div class="container-fluid text-white">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="display-4 text-white">Tenemos la solución</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 text-white">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Temporibus cupiditate eligendi similique, atque odio dicta.
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et vel expedita molestiae praesentium laborum aliquam perferendis. Fugit odit ex repudiandae est, praesentium molestiae fugiat ea id, ducimus dolore perferendis exercitationem.
            </div>
        </div>
        <div class="row py-5">
            <div class="col-md-3 text-white">
                <button type="submit" class="btn btn-outlink-white bg-white text-black btn-lg rounded-pill px-5">cotizar</button>
            </div>
            <div class="col-md-3 text-white">
                <img class="img-fluid" src="{{ asset("imgTmp/123-007.png") }}" alt="Adnorno" style="-webkit-filter: invert(100%) !important;">
            </div>
        </div>
    </div>
  </header>